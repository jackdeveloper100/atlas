...
import AdminArchiveYearsPage from './pages/admin/AdminArchiveYearsPage';
import AdminArchiveYearEditorPage from './pages/admin/AdminArchiveYearEditorPage';
    ...
    <ToastProvider>
      <Routes>
        ...
        >
          ...
          <Route path="/admin/archive" element={<AdminArchiveYearsPage />} />
          <Route path="/admin/archive/years/:year" element={<AdminArchiveYearEditorPage />} />
